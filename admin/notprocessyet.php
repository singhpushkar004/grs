...
$query="select * from tbl_complaint where status='N'";
...
<div class="contaner">
        ...
        <div class="col-sm-9 px-0 py-5 me-1" id="secondcard">
            <h3 align="center" class="text-primary mb-3">Not Processed Complain</h3>
...
<table  class="table table-bordered w-auto table-hover ">
    ...
    <td><a href="status.php?id=<?php echo $row['cmpid'];?>"><button type="button" class="btn btn-primary"> <?php echo $row['status'];?>Not Processed</button></a></td>
