...
<div class="contaner">
        ...
        <div class="col-sm-9 px-0 py-5 me-1" id="secondcard">
            <h3 align="center" class="text-primary mb-3"><b>Pending  Complaint</b></h3>
...
<table  class="table table-bordered w-100 table-hover ">
  ...
  <?php
$query2="select * from tbl_complaint where uid='$uid' and status='P'";
...
?>
   ...
   <?php 
    ...
    <td><?php echo $row2['docomplition'];?></td>
