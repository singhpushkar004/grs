...
$query="select * from tbl_complaint where status='P'";
...
<div class="contaner">
        ...
        <div class="col-sm-9 px-0 py-5 me-1" id="secondcard">
            <h3 align="center" class="text-primary mb-3">Pending Complain</h3>
...
<table  class="table table-bordered w-auto table-hover ">
    ...
    <td><a href="status2.php?id=<?php echo $row['cmpid'] ?>"><button type="button" class="btn btn-primary"> <?php echo $row['status'];?>ending</button></a></td>
