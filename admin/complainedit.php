...
$query="select * from tbl_complain_type where ctid='$id'";
...
<div class="col-sm-6 ms-2 p-4 " id="secondcard">
    <div class="log-card ">
        <h3 align="center" class="p-3">Update Complain</h6>
        <form action="complainupdate.php" method="post" class="p-2">
        <input type="hidden" name="id" value="<?php echo $row['ctid']; ?>">
            <input type="text" name="complain" class="form-control mt-4 p-3" value="<?php echo $row['complain'];?>">
